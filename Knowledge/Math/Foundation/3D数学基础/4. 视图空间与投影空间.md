...
![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_014.png]]

以归一化的相机正上方向量为Y轴，归一化的相机正前方向量为Z轴，归一化的相机右侧（也可以是左侧）方向为X轴建立相机的矩阵空间。

![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_015.png]]

此处每个轴向必须进行归一化Normalize处理以保证该矩阵为正交矩阵。正交矩阵的逆矩阵等于其转置矩阵

![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_016.png]]

最终视图矩阵$Mv = Mt-1 * Mr^-1$

![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_017.png]]
...
![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_018.png]]

此处是个标准的仿射变化，使用6.7的矩阵公式可以得出正交投影的变换矩阵本质上是将视体转换到最终的CVV体，因此转换矩阵如下:

![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_019.png]]

## 2.3 投影变换

按照正常的截头体构建投影空间如下：

![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_020.png]]
...
![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_021.png]]
![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_022.png]]
...
![[Knowledge/Math/Foundation/3D数学基础/attachments/Pic_023.png]]
