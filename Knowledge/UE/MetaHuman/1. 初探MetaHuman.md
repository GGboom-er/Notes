...
![[Knowledge/UE/MetaHuman/attachments/Pic_001.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_002.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_003.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_004.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_003.mp4]]

下面这个视频就是事无巨细版，有需要的同学可以观看：

![[Knowledge/UE/MetaHuman/attachments/Video_004.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_005.png]]

### Step3. 打开UE引擎，用登录Metahuman Creator的账号登录UE的Quixel插件，下载自己的数字人

![[Knowledge/UE/MetaHuman/attachments/Video_002.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_006.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_007.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_008.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_009.png]]
![[Knowledge/UE/MetaHuman/attachments/Pic_010.png]]
![[Knowledge/UE/MetaHuman/attachments/Pic_011.png]]

### 接下来，我们来分析每个独立的Metahuman角色自己的目录

我们也只需要重点关注几个目录

![[Knowledge/UE/MetaHuman/attachments/Pic_012.png]]

**Body**：里面存放的是角色完整的身体的Basecolor也就是漫反射颜色贴图

![[Knowledge/UE/MetaHuman/attachments/Pic_013.png]]

**Face**：这里存放的是重点：每个角色各自的面部/头部的模型，贴图和材质，同时也包含眼睛的材质。这是实现Metahuman千人千面的关键。多个Metahuman角色会使用不同的头部模型，插在相同的身体模型上。

![[Knowledge/UE/MetaHuman/attachments/Pic_014.png]]

**Female**：这里存放的是被裁剪的角色身体。当我们在Metahuman Creator给角色添加衣服以后，那么游戏会为我们提供一个“将被衣服遮住的部位裁减掉的”身体模型，大家可以看见这个模型是只露出手臂和腿部的。

![[Knowledge/UE/MetaHuman/attachments/Pic_015.png]]

![[Knowledge/UE/MetaHuman/attachments/Pic_016.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_021.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_022.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_023.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_024.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_025.png]]

接下来的重点是面部妆容。目前来看Metahuman提供的可以调节妆容分为五块：底色，遮瑕膏色，腮红，眼影还有口红（翻译不周还敬请谅解，我对化妆道具一窍不通..）

![[Knowledge/UE/MetaHuman/attachments/Pic_026.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_027.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_028.png]]

（可以在新页面打开放大）

我们同样从分析基本的漫反射颜色开始入手。身体的基本颜色信息是用了一张贴图呈现，这张贴图作用的范围是数字人锁骨以下的部位。

![[Knowledge/UE/MetaHuman/attachments/Pic_029.png]]

![[Knowledge/UE/MetaHuman/attachments/Pic_030.png]]

颜色信息有两个去处。第一个是通过和（metahuman编辑器web端应用的）黏土材质混合，进入漫反射通道。第二个去处是和散射修正函数进行混合，准确的说是颜色信息决定散射的程度，同时散射程度会被内衣内裤的遮罩覆盖，最终进入不透明度通道。

如图所示是黏土材质的效果

![[Knowledge/UE/MetaHuman/attachments/Pic_031.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_032.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_033.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_034.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_001.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_037.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_005.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_006.mp4]]

![[Knowledge/UE/MetaHuman/attachments/Pic_038.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_039.png]]

![[Knowledge/UE/MetaHuman/attachments/Pic_040.png]]

如上图所示，所谓的解算方向在Control Rig的面条图上是有自己的入口的。

默认的身体Control Rig同时预制了FK/IK控制器，但是很显然我们是不能同时应用FK/IK的。我们需要在Rig Hierarchy中设置

![[Knowledge/UE/MetaHuman/attachments/Pic_041.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_042.png]]

具体的操作步骤视频里会进行进一步的介绍

![[Knowledge/UE/MetaHuman/attachments/Video_007.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_043.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_044.png]]

ii.接着从outliner里拖拽角色进入sequencer窗口

![[Knowledge/UE/MetaHuman/attachments/Pic_045.png]]

iii.接下来我们直接从左上角的animaiton面板上，点击pose按钮

![[Knowledge/UE/MetaHuman/attachments/Pic_046.png]]

iv.初次打开Control Rig Pose面板，我们是没有metahuman的pose库目录的

![[Knowledge/UE/MetaHuman/attachments/Pic_047.png]]

我们需要定位到这个位置

![[Knowledge/UE/MetaHuman/attachments/Pic_048.png]]

v.接下来我们只要从Control Rig Pose菜单找到这个目录，进入任意一个Pose Library即可。通常我们使用Expression目录，这是预制的表情Pose

![[Knowledge/UE/MetaHuman/attachments/Pic_049.png]]

vi.接下来，想用哪个表情，就直接选中该表情，勾选Key选项，点击Select Controls，然后再Paste Pose即可

![[Knowledge/UE/MetaHuman/attachments/Pic_050.png]]

vii.最后结果

![[Knowledge/UE/MetaHuman/attachments/Pic_051.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_052.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_008.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_053.png]]

在默认情况下，Metahuman Creator将为我们设置好一切需要设置的毛发属性，包括毛发的颜色等材质信息。我们只需要在引擎里面按需设置好Groom系统的LOD切换比例即可

![[Knowledge/UE/MetaHuman/attachments/Pic_054.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_055.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_009.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_010.mp4]]

![[Knowledge/UE/MetaHuman/attachments/Pic_056.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_011.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Video_012.mp4]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_057.png]]
...
![[Knowledge/UE/MetaHuman/attachments/Pic_058.png]]
