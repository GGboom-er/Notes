...
---
# 🛠️ MayaMeshRetarget
> **This project provides a tool for retargeting mesh deformation using Radial Basis Functions (RBF) and skin weight-based clustering. It is primarily designed for use in Autodesk Maya, and uses both Maya**

- 📂 [MayaMeshRetarget](file:///Y:/GGbommer/scripts/MayaMeshRetarget)
